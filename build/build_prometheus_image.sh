...
buildah copy prometheus-working-container ./prometheus/prometheus /
buildah copy prometheus-working-container ./prometheus/promtool /
...
buildah copy prometheus-working-container $HOME/go/bin/puzzletest /bin/puzzletest
